...
const ConfirmModal = ({
  ...
  title,
  confirmText = "Yes",
  confirmVariant = "danger", // 'danger' or 'success' or 'primary'
}) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Add aria-hidden to main content for accessibility
      ...
      >
        ...
        >
          <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-2xl">
            ...
            <div className="h-1.5 bg-gradient-to-r from-(--main-color) via-(--main-color-dark) to-(--main-color) bg-[length:200%_100%] animate-gradient" />

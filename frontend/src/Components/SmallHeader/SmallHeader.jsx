...
function SmallHeader() {
  ...
  return (
    <div className="md:hidden  bg-(--white-color) dark:bg-(--dark-alt-color) py-5">
      <div className="container flex justify-between z-50 items-center relative">
        {/* Logo */}
        <div className="image">
          <img
            src="./assets/logo.png"
        ...
        {/* Side Menu */}
        <div
          className={`fixed top-0 right-0 h-full max-md:w-[50%] max-sm:w-[70%] max-[400px]:w-full! bg-(--white-color) dark:bg-(--dark-alt-color) dark:text-(--white-color) text-(--black-color) transform transition-transform duration-300 z-50
